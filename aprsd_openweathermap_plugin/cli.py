#!/usr/bin/env python3
"""
CLI tool for aprsd-openweathermap-plugin configuration export.
"""
...
def export_config_cmd(format="json"):
    ...
    try:
        from aprsd_openweathermap_plugin.conf.opts import export_config
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Export aprsd-openweathermap-plugin configuration options"
    )
    parser.add_argument(
        "--format",
        choices=["dict", "json"],
